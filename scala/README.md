...
In Scala, default List[T] is an immutable LinkedList with O(1) head access and O(n) access to interior elements. You can create a list of names like `val names = List("first","second","third")`.

**TODO: Add more later**

> We are using scalatest library for test cases and we use the Option type whenever applicable.

### [P01](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P01.scala) **(*) Find the last element of a list**
...
### [P02](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P02.scala) **(*) Find the last but one element of a list**
...
### [P03](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P03.scala) **(*) Find the Kth element of a list**
...
### [P04](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P04.scala) **(*) Find the number of elements of a list**
...
### [P05](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P05.scala) **(*) Reverse a list**
...
### [P06](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P06.scala) **(*) Find out whether a list is a palindrome**
...
### [P07](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P07.scala) **(\*\*) Flatten a nested list structure**
...
### [P08](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P08.scala) **(\*\*) Eliminate consecutive duplicates of list elements**
...
### [P09](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P09.scala) **(\*\*) Pack consecutive duplicates of list elements into sublists**
...
### [P10](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P10.scala) **(*) Run-length encoding of a list**
...
### [P11](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P11.scala) **(*) Modified run-length encoding**
...
### [P12](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P12.scala) **(\*\*) Decode a run-length encoded list**
...
### [P13](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P13.scala) **(\*\*) Run-length encoding of a list (direct solution)**
...
### [P14](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P14.scala) **(*) Duplicate the elements of a list**
...
### [P15](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P15.scala) **(\*\*) Duplicate the elements of a list a given number of times**
...
### [P16](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P16.scala) **(\*\*) Drop every N'th element from a list**
...
### [P17](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P17.scala) **(*) Split a list into two parts; the length of the first part is given**
...
### [P18](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P18.scala) **(\*\*) Extract a slice from a list**
...
### [P19](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P19.scala) **(\*\*) Rotate a list N places to the left**
...
### [P20](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P20.scala) **(*) Remove the K'th element from a list**
...
### [P21](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P21.scala) **(*) Insert an element at a given position into a list**
...
### [P22](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P22.scala) **(*) Create a list containing all integers within a given range**
...
### [P23](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P23.scala) **(\*\*) Extract a given number of randomly selected elements from a list**
...
### [P24](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P24.scala) **(*) Lotto: Draw N different random numbers from the set 1..M**
...
```
### [P25](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P25.scala) **(*) Generate a random permutation of the elements of a list**
...
### [P26](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P26.scala) **(\*\*) Generate the combinations of K distinct objects chosen from the N elements of a list**
...
### [P27](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P27.scala) **(\*\*) Group the elements of a set into disjoint subsets**
...
### [P28](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_01_lists/P28.scala) **(\*\*) Sorting a list of lists according to length of sublists**
...
### [P31](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P31.scala) **(\*\*) Determine whether a given integer number is prime.**
...
### [P32](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P32.scala) **(\*\*) Determine the prime factors of a given positive integer.**
...
### [P33](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P33.scala) **(\*\*) Determine the prime factors of a given positive integer (2).**
...
### [P34](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P34.scala) **(*) A list of prime numbers.**
...
### [P35](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P35.scala) **(\*\*)  Goldbach's conjecture.**
...
### [P36](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P36.scala) **(\*\*)  A list of Goldbach compositions.**
...
### [P37](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P37.scala) **(\*\*)  Determine the greatest common divisor of two positive integer numbers**
...
### [P38](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P38.scala) **(*) Determine whether two positive integer numbers are coprime.**
...
### [P39](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P39.scala) **(\*\*) Calculate Euler's totient function phi(m).**
...
### [P40](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P40.scala) **(\*\*) Calculate Euler's totient function phi(m) (2).**
...
### [P41](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_02_arithmetic/P41.scala) **(*) Compare the two methods of calculating Euler's totient function.**
...
### [P46](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_03_logic_and_codes/P46.scala) **(\*\*) Truth tables for logical expressions.**
...
### [P47](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_03_logic_and_codes/P47.scala) **(*) Truth tables for logical expressions (2).**

Skipping this problem for now.

### [P48](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_03_logic_and_codes/P48.scala) **(\*\*) Truth tables for logical expressions (3).**

Skipping this problem for now.

### [P49](https://github.com/fbaumgardt/99-problems/blob/master/scala/src/main/scala/com/fbaumgardt/ninetynine_problems/_03_logic_and_codes/P49.scala) **(\*\*) Gray code.**
